...
class AboutController extends Controller
{
    ...
    public function get(Request $request){
        $user = Auth::user();
        return view("home.user.profile.about",['user' => $user, 'addFriendButton' => false, 'sendMessageButton' => false]);
    }
    ...
    public function getUser($user){
        ...
        return view("home.user.profile.about",['user' => $user, 'addFriendButton' => $addFriendButton, 'cancelFriendButton' => $cancelFriendButton, 'acceptFriendButton' => $acceptFriendButton, 'deniedFriendButton' => $deniedFriendButton, 'blockFriendButton' => $blockFriendButton, 'unblockFriendButton' => $unblockFriendButton, 'unfriendButton' => $unfriendButton, 'sendMessageButton' => $sendMessageButton]);
