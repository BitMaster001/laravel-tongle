...
class FriendsController extends Controller
{
    ...
    public function get(){
        $user = Auth::user();
        return view("home.user.profile.friends",['user' => $user]);
    }
    ...
    public function getUser($user){
        ...
        if($authUser != null && $authUser->id == $user->id){
            return redirect(route('userFriendsGet'));
        }
        ...
        return view("home.user.profile.friends",['user' => $user, 'addFriendButton' => $addFriendButton, 'cancelFriendButton' => $cancelFriendButton, 'acceptFriendButton' => $acceptFriendButton, 'deniedFriendButton' => $deniedFriendButton, 'blockFriendButton' => $blockFriendButton, 'unblockFriendButton' => $unblockFriendButton, 'unfriendButton' => $unfriendButton, 'sendMessageButton' => $sendMessageButton]);
    }
}
