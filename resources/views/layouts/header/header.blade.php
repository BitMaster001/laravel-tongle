<header class="header jnt-added">
    ...
    <div class="header-actions">
        ...
        <div class="action-list dark">
            ...
            @include('layouts.header.partial.messages')
            <!-- /ACTION LIST ITEM WRAP -->

            <!-- ACTION LIST ITEM WRAP -->
            @include('layouts.header.partial.friend-requests')
            <!-- /ACTION LIST ITEM WRAP -->
            @if(false)
            <!-- ACTION LIST ITEM WRAP -->
            @include('layouts.header.partial.shopping-cart')
            <!-- /ACTION LIST ITEM WRAP -->

            <!-- ACTION LIST ITEM WRAP -->
            @include('layouts.header.partial.notifications')
            <!-- /ACTION LIST ITEM WRAP -->
            @endif
        </div>
        <!-- /ACTION LIST -->
        ...
        <!-- ACTION ITEM WRAP -->
        @include('layouts.header.partial.settings')
        <!-- /ACTION ITEM WRAP -->
    </div>
    <!-- /HEADER ACTIONS -->
    ...
    <p class="d-none">
        <audio id="jntClickAudio" style="display:none" controls>
            <source src="{{ asset('assets/audio/click-sound.mp3') }}" type="audio/mpeg">
