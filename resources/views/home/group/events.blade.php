...
$upcomingEvents = $group->getUpcomingEvents($date);
$pastEvents = $group->getPastEvents($date);
@endphp
...
<div class="section-header">
    ...
    <div class="section-header-info">
        <!-- SECTION PRETITLE -->
        <p class="section-pretitle">Past hosting events!</p>
        <!-- /SECTION PRETITLE -->

        <!-- SECTION TITLE -->
        <h2 class="section-title">Events <span class="highlighted">{{count($pastEvents)}}</span></h2>
        <!-- /SECTION TITLE -->
    </div>
    <!-- /SECTION HEADER INFO -->
</div>
...
@if(count($upcomingEvents)+count($pastEvents)==0)
<br>
<!-- SECTION HEADER -->
<div class="section-header">
    <!-- SECTION HEADER INFO -->
