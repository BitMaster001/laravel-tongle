<div class="account-hub-sidebar desktop">
    <!-- SIDEBAR BOX -->
    <div class="sidebar-box no-padding">
        ...
        <div class="sidebar-menu">
            ...
            <div class="sidebar-menu-item">
                ...
                <div class="sidebar-menu-body accordion-content-linked accordion-open">
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsProfileInfoGet')}}">Profile Info</a>
                    <!-- /SIDEBAR MENU LINK -->

                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsSocialStreamGet')}}">Social &amp; Stream</a>
                    <!-- /SIDEBAR MENU LINK -->

                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsMessagesGet')}}">Messages</a>
                    <!-- /SIDEBAR MENU LINK -->

                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsFriendRequestsGet')}}">Friend Requests</a>
                    <!-- /SIDEBAR MENU LINK -->
                </div>
                <!-- /SIDEBAR MENU BODY -->
            </div>
            ...
            <div class="sidebar-menu-item">
                ...
                <div class="sidebar-menu-body accordion-content-linked">
                    ...
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsChangePasswordGet')}}">Change Password</a>
                    <!-- /SIDEBAR MENU LINK -->

                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsGeneralSettingsGet')}}">General Settings</a>
                    <!-- /SIDEBAR MENU LINK -->
            ...
            <div class="sidebar-menu-item">
                ...
                <div class="sidebar-menu-body accordion-content-linked">
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsManageGroupsGet')}}">Manage Groups</a>
                    <!-- /SIDEBAR MENU LINK -->

                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsInvitationsGet')}}">Invitations</a>
                    <!-- /SIDEBAR MENU LINK -->
                </div>
                <!-- /SIDEBAR MENU BODY -->
            </div>
            ...
            <div class="sidebar-menu-item">
                ...
                <div class="sidebar-menu-body accordion-content-linked">
                    ...
                    @endif
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{route('settingsManageStoreGet')}}">Manage Items</a>
                    <!-- /SIDEBAR MENU LINK -->
                    @if(false)
                    <!-- SIDEBAR MENU LINK -->
        ...
        <div class="sidebar-box-footer">
            ...
            <!-- BUTTON -->
            <a class="button white small-space" href="{{ route('userProfileGet') }}">
            Discard All
            </a>
            <!-- /BUTTON -->
        </div>
