...
<div class="container">
    <div class="bhs_row" style="height:100vh;align-items:center;justify-content:center">
        <div class="bhs_desktop_one_third bhs_mobile_full_width">
            <div style="text-align:center">
                <p class="bhs_logo">TONGLE</p>
            </div>
            <form class="form light-border" method="POST" action="{{ route('loginPost') }}">
                <div class="bhs_row bhs_full_width border_bottom">
                    <span style="color:#FFF">Login</span>
                    <a href="https://alpha.ljltongle.com/register" style="color:#56baca;margin-left:auto" id="register-button">REGISTRATION</a>
                </div>
                @csrf
                ...
                <div class="bhs_row">
                    <div class="bhs_form_item">
                        <div class="bhs_form_input">
                            ...
                            <input class="@error('username-email') is-invalid @enderror bhs_input" type="text" id="username-email" name="username-email" value="{{ old('username-email') }}">
                ...
                <div class="bhs_row">
                    <div class="bhs_form_item">
                        <div class="bhs_form_input">
                            <label for="password">Password<a style="margin-left:auto" href="{{route('resetPasswordGet')}}">Forgot Password?</a></label>
                ...
                <div class="bhs_form_row">
                    <div class="bhs_form_item">
                        <button class="bhs_button">Login</button>
                    </div>
                </div>

                <div style="padding-top:0">
                    <input type="checkbox" id="remember_me" name="remember_me" checked>
                    <label for="remember_me"><span class="icon"></span>Remember Me</label>
                </div>
            </form>
        </div>
    </div>
