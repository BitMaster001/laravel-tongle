<aside class="floaty-bar">
    ...
    <div class="bar-actions">
        ...
        <div class="action-list dark">
            ...
            <!-- ACTION LIST ITEM -->
            <a class="action-list-item" href="<?php echo e(route('settingsMessagesGet')); ?>">
                <!-- ACTION LIST ITEM ICON -->
                <svg class="action-list-item-icon icon-messages">
                    <use xlink:href="#svg-messages"></use>
                </svg>
            ...
            <!-- ACTION LIST ITEM -->
            <a class="action-list-item" href="<?php echo e(route('settingsFriendRequestsGet')); ?>">
                <!-- ACTION LIST ITEM ICON -->
                <svg class="action-list-item-icon icon-friend">
                    <use xlink:href="#svg-friend"></use>
                </svg>
        ...
        <!-- ACTION ITEM WRAP -->
        <a class="action-item-wrap" href="<?php echo e(route('settingsProfileInfoGet')); ?>">
            <!-- ACTION ITEM -->
...
<?php /**PATH E:\xampp\htdocs\msm\resources\views/layouts/header/mobile.blade.php ENDPATH**/ ?>