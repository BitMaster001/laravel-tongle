    ...
    <div id="stats-box-slider-items" class="stats-box-slider-items">
        ...
        <div class="stats-box stat-profile-views">
            ...
            <div class="stats-box-value-wrap">
                <!-- STATS BOX VALUE -->
                <p class="stats-box-value"><?php echo e($user->visits); ?></p>
                <!-- /STATS BOX VALUE -->
        ...
        <div class="stats-box stat-posts-created">
            ...
            <div class="stats-box-value-wrap">
                <!-- STATS BOX VALUE -->
                <p class="stats-box-value"><?php echo e($user->posts); ?></p>
                <!-- /STATS BOX VALUE -->
        ...
        <div class="stats-box stat-reactions-received">
            ...
            <div class="stats-box-value-wrap">
                <!-- STATS BOX VALUE -->
                <p class="stats-box-value"><?php echo e($reactionsReceived); ?></p>
                <!-- /STATS BOX VALUE -->
        ...
        <div class="stats-box stat-comments-received">
            ...
            <div class="stats-box-value-wrap">
                <!-- STATS BOX VALUE -->
                <p class="stats-box-value"><?php echo e($commentsReceived); ?></p>
                <!-- /STATS BOX VALUE -->
                <?php if(false): ?>
                <!-- STATS BOX DIFF -->
                <div class="stats-box-diff">
...
<!-- /STATS BOX SLIDER -->
<?php /**PATH E:\xampp\htdocs\msm\resources\views/home/newsfeed/widgets/stats.blade.php ENDPATH**/ ?>