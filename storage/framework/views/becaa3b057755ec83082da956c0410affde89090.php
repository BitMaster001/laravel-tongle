<nav id="navigation-widget" class="navigation-widget navigation-widget-desktop sidebar left hidden" data-simplebar>
    ...
    <figure class="navigation-widget-cover liquid">
        <img src="<?php echo e(Auth::user()->cover ?? '/storage/default/user/profile/cover.jpg'); ?>" alt="cover-01">
    </figure>
    <!-- /NAVIGATION WIDGET COVER -->
    ...
    <div class="user-short-description">
        ...
        <a class="user-short-description-avatar user-avatar medium" href="<?php echo e(route('userProfileGet')); ?>">
            <!-- USER AVATAR BORDER -->
            ...
            <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-82-90" data-src="<?php echo e(Auth::user()->avatar ?? '/storage/default/user/profile/avatar.jpg'); ?>"></div>
                <!-- /HEXAGON -->
            </div>
            <!-- /USER AVATAR CONTENT -->
        ...
        <p class="user-short-description-title"><a href="<?php echo e(route('userProfileGet')); ?>"><?php echo e(Auth::user()->full_name ?? Auth::user()->username); ?></a></p>
        <!-- /USER SHORT DESCRIPTION TITLE -->

        <!-- USER SHORT DESCRIPTION TEXT -->
        <p class="user-short-description-text"><a href="<?php echo e(Auth::user()->website ?? '#'); ?>" target="_blank"><?php echo e(parse_url(Auth::user()->website)['host'] ?? ''); ?></a></p>
        <!-- /USER SHORT DESCRIPTION TEXT -->
    </div>
    <!-- /USER SHORT DESCRIPTION -->
...
<?php /**PATH E:\xampp\htdocs\msm\resources\views/layouts/sidebar/desktop.blade.php ENDPATH**/ ?>