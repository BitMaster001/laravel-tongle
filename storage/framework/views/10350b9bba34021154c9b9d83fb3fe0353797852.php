        ...
        <div class="widget-box" style="padding-left:2px;padding-right:2px;">
            <div class="widget-box-content">
                <div class="user-status-list">
                    <?php $__currentLoopData = $adminMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- USER STATUS -->
                    <div style = "min-height:70px;">
                        <!-- USER STATUS AVATAR -->
                        <a class="user-status-avatar" id="<?php echo e($member->id); ?>" name="<?php echo e($member->username . '_admin'); ?>"  style="cursor:pointer" onclick="getCurrentAdminUser(name)"> 
                            <!-- USER AVATAR -->
                            <center>
                            ...
                            <!-- /USER AVATAR -->
                            <!-- USER NAME -->
                            <p class="user-status-text small" style="text-align: center; word-wrap: break-word"><?php echo e($member->username); ?></p>
                            <!-- /USER NAME -->
                        </center>
                        </a>
                        <!-- /USER STATUS AVATAR -->
    ...
    <div class="grid-column" style="height:600px">
        ...
        <div class="widget-box" style="padding-left:2px;padding-right:2px;overflow:hidden auto;height:550px">
            <div class="widget-box-content" style="margin-left: 0px;">
                <div class="user-status-list">
                    <?php $__currentLoopData = $allMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- USER STATUS -->
                    <div style = "min-height:70px;">
                        <!-- USER STATUS AVATAR -->
                        <center>
                        <a class="user-status-avatar"  id="<?php echo e($member->id); ?>"  name="<?php echo e($member->username); ?>" style="cursor:pointer" onclick="getCurrentUser(name)">
                            <!-- USER AVATAR -->
                            <div class="user-avatar small no-outline">
                                <!-- USER AVATAR CONTENT -->
                                <div class="user-avatar-content">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\msm\resources\views/admin/conversation.blade.php ENDPATH**/ ?>