<nav class="section-navigation">
    ...
    <div id="section-navigation-slider" class="section-menu">
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('userAboutGet') : route('userPublicAboutGet', ['user' => $user->username])); ?>">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('userProfileGet') : route('userPublicProfileGet', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('userFriendsGet') : route('userPublicFriendsGet', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('userGroupsGet') : route('userPublicGroupsGet', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
        ...
        <?php if(false): ?>
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('stream') : route('userStream', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('getBlogs') : route('getUserBlogs', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('getUserEvent') : route('getPublicUserEvent', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="<?php echo e(Auth::user() == $user ? route('userStoreGet') : route('userPublicStoreGet', ['user' => $user->username])); ?>">
            <!-- SECTION MENU ITEM ICON -->
...
<?php /**PATH E:\xampp\htdocs\msm\resources\views/home/user/profile/partial/profile-navigation.blade.php ENDPATH**/ ?>