<header class="header jnt-added">
    ...
    <div class="header-actions">
        ...
        <div class="header-brand">
            ...
            <div class="logo">
                <!-- ICON LOGO TongLe -->
                <img class="logo-tongle small" src="/assets/img/landing/logo.jpg">
                <img class="logo-tongle-mobile small" src="/assets/img/landing/logo-mobile.jpg">
                <!-- /ICON LOGO TongLe -->
            </div>
            <!-- /LOGO -->
        </div>
    ...
    <div class="header-actions search-bar">
        ...
        <div class="interactive-input dark">
            <!--<input type="text" id="search-main" name="search_main" placeholder="Search for peoples, groups and more...">-->
            <input type="text" id="header-search" name="header-search" placeholder="Search for peoples, groups and more...">
            ...
            <div class="interactive-input-action" id="header-search-clear">
        ...
        <?php if(true): ?>
        <!-- DROPDOWN BOX -->
        <div class="dropdown-box padding-bottom-small header-search-dropdown" id="header-search-dropdown">
            <?php if(false): ?>
    ...
    <div class="header-actions">
        ...
        <div class="action-list dark">
            ...
            <?php echo $__env->make('layouts.header.partial.messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /ACTION LIST ITEM WRAP -->

            <!-- ACTION LIST ITEM WRAP -->
            <?php echo $__env->make('layouts.header.partial.friend-requests', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /ACTION LIST ITEM WRAP -->
            <?php if(false): ?>
            <!-- ACTION LIST ITEM WRAP -->
            <?php echo $__env->make('layouts.header.partial.shopping-cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /ACTION LIST ITEM WRAP -->

            <!-- ACTION LIST ITEM WRAP -->
            <?php echo $__env->make('layouts.header.partial.notifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /ACTION LIST ITEM WRAP -->
            <?php endif; ?>
        </div>
        <!-- /ACTION LIST -->
        ...
        <!-- ACTION ITEM WRAP -->
        <?php echo $__env->make('layouts.header.partial.settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /ACTION ITEM WRAP -->
    </div>
    <!-- /HEADER ACTIONS -->

    <p class="d-none">
        <audio id="jntClickAudio" style="display:none" controls>
            <source src="<?php echo e(asset('assets/audio/click-sound.mp3')); ?>" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
    </p>
</header>
<?php /**PATH E:\xampp\htdocs\msm\resources\views/layouts/header/header.blade.php ENDPATH**/ ?>