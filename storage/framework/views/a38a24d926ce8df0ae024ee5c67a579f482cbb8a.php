            ...
            <div class="widget-box-content-slider-item">
                ...
                <div class="reaction-stats">
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Like'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Love'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
                ...
                <div class="reaction-stats">
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Dislike'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Happy'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
            ...
            <div class="widget-box-content-slider-item">
                ...
                <div class="reaction-stats">
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Funny'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Wow'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
                ...
                <div class="reaction-stats">
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Angry'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
                    ...
                    <div class="reaction-stat">
                        ...
                        <!-- REACTION STAT TITLE -->
                        <p class="reaction-stat-title"><?php echo e($reactionsReceived['Sad'] ?? 0); ?></p>
                        <!-- /REACTION STAT TITLE -->
...
<!-- /WIDGET BOX -->
<?php /**PATH E:\xampp\htdocs\msm\resources\views/home/newsfeed/widgets/reactions.blade.php ENDPATH**/ ?>